table 50004 "ODT FT Job Mapping Lines"
{
            ...
            begin
                case Type of
                    ...
                    Type::Resource:
                        ...
                        if PAGE.RUNMODAL(0, UnitOfMeasure) = ACTION::LookupOK then VALIDATE("Unit of Measure Code", UnitOfMeasure.Code);
                end;
            end;
    ...
    var
        LSDFormats: Record "ODT LSD Format";
        "--NB03.45": Integer;
        Job: Record Job;
    ...
    begin
        ...
        END
        ELSE
            IF (Type = Type::Resource) OR ("Employee No." <> '') THEN BEGIN
                ResCost.INIT;
                IF "Employee No." <> '' THEN
                    ResCost.Code := "Employee No."
                ELSE
                    ResCost.Code := "No.";
    ...
    Local procedure InitRoundingPrecision()
    begin
