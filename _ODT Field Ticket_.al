    ...
    dataset
    {
        ...
        "ODT Field Ticket Job Mapping")
        {
            ...
            "Integer")
            {
                ...
                column(Header_InvoiceDescription;
                Job.InvoiceDescription)
                {
                }
